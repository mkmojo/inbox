 ...
 *  Project: TreeWorks
 *
 *  File: adjacent_nodes_generate_function.hpp
 *  Created: Aug 16, 2009
 *
 *  Author: Abhinav Sarje <abhinav.sarje@gmail.com>
 */

#ifndef ADJACENT_NODES_GENERATE_FUNCTION_HPP
#define ADJACENT_NODES_GENERATE_FUNCTION_HPP
...
// the set of all the 26 adjacent blocks around the local_node, and local_node itself.
class AdjacentNodesGenerate {
	private:
	...
	public:
		...
		bool operator()(const tree_type& t, const tree_node& local_node,
			...
			// compute the proximate blocks around the local_node, if it is a leaf
...
#endif // ADJACENT_NODES_GENERATE_FUNCTION_HPP
